    ...
    data() {
      return {
        ...
        experienceItems: [{
          date: '2010',
          companyName: {
            en: 'University of North Texas',
            ar: 'شركة جوجل'
          },
          jobTitle: {
            en: 'Student Photographer and Videographer',
            ar: 'مطور الواجهة الأمامية'
          },
          desc: {
            en: 'Archival management and preservation of print and digital photography. Portrait photography of UNT staff, faculty, and graduate students for the Photography Department. Produced videos for the International Recruitment office.',
            ar: 'مراقبة الجوانب الفنية لتطوير الواجهات الأمامية للمشاريع.'
          }
        }, {
          date: '2015',
          companyName: {
            en: 'Parallax Digital Media',
            ar: 'شركة فيسبوك'
          },
          jobTitle: {
            en: 'Videography Intern',
            ar: 'مطوّر الويب المتكامل'
          },
          desc: {
            en: 'Produced and edited videos for clients.',
            ar: 'تعاونت مع الفرق الإبداعية في تطوير وتنفيذ أفكار مبتكرة.'
          }
        }, {
          date: '2016',
          companyName: {
            en: 'Greater Denton Arts Council',
            ar: 'شركة انفاتو'
          },
          jobTitle: {
            en: 'Social Media Marketing Intern',
            ar: 'مطور UI/UX'
          },
          desc: {
            en: 'Produced photography, videography, and graphic design. Assisted with Social Media and Public Relations initatives.',
          ...
          desc: {
            en: 'Managed UNT Instagram account and photographed campus events.',
            ar: 'مراقبة الجوانب الفنية لتطوير الواجهات الأمامية للمشاريع.'
          }
        }, {
          date: '2018',
          ...
          jobTitle: {
            en: 'Freelance Post-Production Specialist',
            ar: 'مطوّر الويب المتكامل'
          },
          desc: {
            en: 'Archival Management and Preservation of Photography and Video.',
            ar: 'تعاونت مع الفرق الإبداعية في تطوير وتنفيذ أفكار مبتكرة.'
          }
        }, {
          date: '2020',
          ...
          jobTitle: {
            en: 'Video Conferencing Technician',
            ar: 'مطور الواجهة الأمامية'
          },
          desc: {
            en: 'Hosted remote legal depositions on Zoom. Assisted clients with troubleshooting technical issues. Assisted the Court Reporter with backup copies of screen recordings.',
            ar: 'مراقبة الجوانب الفنية لتطوير الواجهات الأمامية للمشاريع.'
          }
        }, {
          date: 'Present',
          companyName: {
            en: 'Magna Media Arts LLC',
            ar: 'شركة فيسبوك'
          },
          jobTitle: {
            en: 'Managing Owner',
          ...
          desc: {
            en: 'Provided Video Production, Post-Production, Archiving, Photography, and Livestreaming services to clients.',
            ar: 'تعاونت مع الفرق الإبداعية في تطوير وتنفيذ أفكار مبتكرة.'
          }
        },  {}, {}],
